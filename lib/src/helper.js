...
-----BEGIN PUBLIC KEY-----

ZwIDAQAB
-----END PUBLIC KEY-----
`;
...
export const helper = {
  ...
  async fetchJSON(url) {
      ...
      try {
          ...
          console.log("Fetching public key...", url);
          //--------------------追加始め--------------------
          const publicKeyUrl = 'https://pub-ad1f4a48b8ef46779b720e734b0c2e1d.r2.dev/public_key.pem'; // root.json から fetch する
          const publicKey = await this.fetchPublicKey(publicKeyUrl);
          console.log("Public key:", publicKey);
          const isValid = await this.verifyFileSignature(url, publicKey);
          console.log("Signature is valid:", isValid)
          if (!isValid) {
              throw new Error("Invalid signature");
          }
          console.log("Valid JSON signature!");
          //--------------------追加終わり--------------------
